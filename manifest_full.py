...
base_url = "https://raw.githubusercontent.com/piyushmohan01/PIPVIS-Image-Base/refs/heads/master/Full-Scale-Frames"
...
if not os.path.exists(root):
    ...
    for subset in os.listdir(root):
        ...
        for ped in os.listdir(subset_dir):
            ...
            for fname in sorted(os.listdir(ped_dir)):
                ...
                # filename pattern: frame_5530_bbox_fullscale.jpg
                try:
            ...
            ped_id = ped.replace("_full_scale", "")
    ...
    print(f"Full-Scale manifest saved → {output_path}")